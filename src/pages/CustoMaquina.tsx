...
import { 
  Calculator, DollarSign, Save, CheckCircle2, Clock
} from 'lucide-react';
      ...
      <div className="w-full max-w-2xl mx-auto mt-12">
        <form onSubmit={handleSubmit} className="glass-panel p-8 rounded-3xl flex flex-col gap-6 shadow-xl border border-gold/20 bg-white/10 backdrop-blur-md">
          <div className="flex items-center gap-3 text-gold-dark border-b border-gold/20 pb-4">
            <Calculator size={24} />
            <h3 className="text-xl font-serif font-bold">Configuração de Custo</h3>
          </div>
          ...
          <div className="bg-gold/5 p-4 rounded-2xl border border-gold/20 text-xs text-gray-600 leading-relaxed">
            ...
            Este valor é fundamental para o cálculo preciso dos orçamentos de produtos de Corte a Laser. 
            Ele deve englobar o consumo de energia, manutenção preventiva, depreciação da máquina e outros custos operacionais diretos.
          </div>
