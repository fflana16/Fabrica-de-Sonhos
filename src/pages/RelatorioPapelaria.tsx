...
export const RelatorioPapelaria = ({ 
  onNavigate, 
  onBack,
  onBackStep,
  onBackToCategory,
  ...
  const { produtosPapelaria, removerProdutoPapelaria, setProdutoPapelariaParaEditar, currentUser } = useSistemas();
  ...
  return (
    <PageLayout 
      title="Relatório de Produtos de Papelaria" 
      onBack={onBack} 
