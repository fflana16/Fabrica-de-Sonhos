        ...
        <div className="mt-12 glass-panel p-8 rounded-3xl flex flex-col gap-6 shadow-xl border border-red-500/20 bg-red-50/5 backdrop-blur-md">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-sm text-gray-600">
              Ao efetuar o reset do sistema, todos os dados de clientes, produtos, insumos, orçamentos, pedidos e <strong>usuários (exceto Fernando)</strong> serão permanentemente excluídos. 
