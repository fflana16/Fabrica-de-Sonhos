...
export const CancelamentoOrcamentoModal = ({
  orcamento,
  onClose,
  onConfirm
}: CancelamentoOrcamentoModalProps) => {
        ...
        <div className="flex flex-col gap-4 mb-6">
            ...
            {opcoes.map(opcao => (
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setJustificativaSelecionada(e.target.value)
                  }
          ...
          {justificativaSelecionada === 'Outros' && (
            <div className="mt-2 animate-in fade-in slide-in-from-top-2">
              <label className="text-xs font-bold text-red-700 uppercase tracking-wider ml-1 mb-1 block">
                Descreva o motivo:
              </label>
              <textarea
                value={outraJustificativa}
                onChange={(e) =>
                  setOutraJustificativa(e.target.value)
                }
