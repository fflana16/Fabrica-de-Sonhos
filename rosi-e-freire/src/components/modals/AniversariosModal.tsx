                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {cliente.dataNascimento && (
                        <p className="text-sm text-gray-600">{format(parseDate(cliente.dataNascimento)!, 'dd/MM', { locale: ptBR })}{activeTab === 'proximos' && ` (${format(new Date(new Date().getFullYear(), parseDate(cliente.dataNascimento)!.getMonth(), parseDate(cliente.dataNascimento)!.getDate()), 'dd/MM/yyyy', { locale: ptBR })})`}</p>
                      )}
                    </div>
                  </div>
